...
// WithName adds the name to the delete cluster params
func (o *DeleteClusterParams) WithName(name string) *DeleteClusterParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete cluster params
func (o *DeleteClusterParams) SetName(name string) {
	o.Name = name
}
