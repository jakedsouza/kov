...
//go:generate swagger generate server --target .. --name vccs --spec ../../../../swaggerspec/swagger.yml

func configureFlags(api *operations.VccsAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.VccsAPI) http.Handler {
