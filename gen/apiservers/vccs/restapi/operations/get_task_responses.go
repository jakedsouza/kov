...
/*GetTaskOK the task for the given task id
...
/*GetTaskNotFound The task was not found
...
// WithPayload adds the payload to the get task not found response
func (o *GetTaskNotFound) WithPayload(payload *models.Error) *GetTaskNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get task not found response
func (o *GetTaskNotFound) SetPayload(payload *models.Error) {
	o.Payload = payload
}
